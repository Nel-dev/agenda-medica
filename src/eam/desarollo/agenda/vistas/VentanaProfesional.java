...
public class VentanaProfesional extends JInternalFrame {
	...
	public VentanaProfesional() {
		...
		btnGuargar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(crear_nuevoProfesinal()==null){
					//JOptionPane.showMessageDialog(null, "Debe llenar todos los campos", "Info",
					...
					if(crear_nuevoProfesinal()!=null){
						...
						//listarProfesional();
						Limpiarformulario();
						JOptionPane.showMessageDialog(null, "El Profesional se ha registrado", "Registro ingresado",
								JOptionPane.INFORMATION_MESSAGE);
					//daoP.listarProfesional();
					}
		...
		btnActualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					if (crear_nuevoProfesinal() != null) {
						Profesional pro=daoP.buscar(tfIdentificacion.getText());
						if(pro!=null){
							daoP.actualizar(nuevo_Profesional);
							JOptionPane.showMessageDialog(null, "Actualización Exitosa",
									"Actualización Exitos", JOptionPane.INFORMATION_MESSAGE);
							Limpiarformulario();
							tfIdentificacion.enable(true);
						}else{
							JOptionPane.showMessageDialog(null, "Actualización erronea,no existe registro", "Info",
									JOptionPane.INFORMATION_MESSAGE);
						}
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if(tfIdentificacion.getText().isEmpty()){
						JOptionPane.showMessageDialog(null, "debe llenar el campo el de identificacion",
								"debe llenar el campo", JOptionPane.INFORMATION_MESSAGE);
					}
					else
						{
					if(pro==null){
						JOptionPane.showMessageDialog(null, "No se ecuentra el Profesional",
									"No se ecuentra ese Profesinal", JOptionPane.INFORMATION_MESSAGE);
					}
					else{
						Cargarformulario(pro);
						tfIdentificacion.disable();
						}
					}
		...
		btnEliminar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					if(tfIdentificacion.getText().isEmpty()){
						JOptionPane.showMessageDialog(null, "debe llenar el campo de identificacion",
								"debe llenar el campo", JOptionPane.INFORMATION_MESSAGE);
					}else{
						if(daoP.buscar(tfIdentificacion.getText())!=null){
							daoP.eliminar(Integer.parseInt(tfIdentificacion.getText()));
							Limpiarformulario();
							tfIdentificacion.enable(true);
							JOptionPane.showMessageDialog(null, "Se elimino correctamente",
									"Se elimino correctamente", JOptionPane.INFORMATION_MESSAGE);
							
						}else{
							JOptionPane.showMessageDialog(null, "El profesional no se encuentra",
									"El profesional no se encuentra", JOptionPane.INFORMATION_MESSAGE);
						}
	 ...
	 * @return boolean
	 */
	public boolean actualizar_Profesional() {
		for (int i = 0; i < datosAgenda.getProfesional_arrayList().size(); i++) {
			if (datosAgenda.getProfesional_arrayList().get(i).getIdentificacionProfesional() == Integer
					.parseInt(tfIdentificacion.getText())) {
